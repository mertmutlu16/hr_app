                      ...
                      return SizedBox(
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: Padding(
                              padding: EdgeInsets.only(bottom : 1.5.h , left: 2.h , right: 2.h),
                              child: Column(
                                mainAxisAlignment:
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      GestureDetector(
                                        onTap: ()  {
                                          setState(() async {
                                             await   notificationScreenViewModel.removeNotification(notificationScreenViewModel.notificationsListByUser[index].id);
                                                 notificationScreenViewModel.notificationsListByUser.clear();
                                                 notificationScreenViewModel.getNotificationsListByUser(loginScreenViewModel.user!.id);                                        
                                          });
                                        },
                                        child: const Icon(
                                          Icons.clear,
