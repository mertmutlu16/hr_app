...
class TaskManagerScreenViewModel = _TaskManagerScreenViewModelBase with _$TaskManagerScreenViewModel;
...
abstract class _TaskManagerScreenViewModelBase with Store {
    ...
    Future<List<Task>> getTaskFromNotion() async {
      ...
      tasksList.addAll((data['results'] as List).map((e) => Task.fromMap(e)).toList() );
      return tasksList;
    }
